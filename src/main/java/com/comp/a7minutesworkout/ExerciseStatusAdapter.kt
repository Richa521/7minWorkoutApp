...
import com.comp.a7minutesworkout.databinding.ItemExerciseStatusBinding
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        when {
            ...
            model.getIsCompleted() -> {
                ...
                holder.tvItem.background =
                    ContextCompat.getDrawable(holder.itemView.context, R.drawable.itm_circular_color_grey_background)
